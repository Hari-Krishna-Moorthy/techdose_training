...
class previousSmallestElement {
	static public int[] previousSmallestElement(int[] nums1, int[] nums2) {
    ...
    public static void main(String[] args) {
    	System.out.println(Arrays.toString(previousSmallestElement(new int[] {4,1,2}, new int[] {1,3,4,2})));
    	System.out.println(Arrays.toString(previousSmallestElement(new int[] {2,4}, new int[] {10, 1, 2, 3, 4})));
    }
}
